-- Fix: completed follow-ups were grouped by recorded_at instead of the original
-- appointment's scheduled_at. The dashboard date range should filter done_scope
-- by when the appointment was scheduled, not when the follow-up was recorded.
