...
describe("DashboardShell", () => {
  ...
  it("renders the header utilities and expanded navigation", () => {
    const { container } = render(<DashboardShell navItems={items} user={{ fullName: "Ada Admin", roleLabel: "admin", profileHref: "/profile" }} theme="light"><h1>Content</h1></DashboardShell>);
  ...
  it("persists, snapshots, and restores collapsed state", async () => {
    const { container, unmount } = render(<DashboardShell navItems={items} user={{ fullName: "Ada Admin", roleLabel: "admin" }} theme="light">Content</DashboardShell>);
    ...
    expect(container).toMatchSnapshot();
    unmount();
    render(<DashboardShell navItems={items} user={{ fullName: "Ada Admin", roleLabel: "admin" }} theme="light">Content</DashboardShell>);
  ...
  it("only renders navigation entries supplied by the visibility model", () => {
    render(<DashboardShell navItems={[items[0]]} user={{ fullName: "Doc User", roleLabel: "doctor" }} theme="dark">Content</DashboardShell>);
