...
- **Stable code:** `REVENUE_REPORT`
- **English name:** Revenue Report
- **Arabic name:** تقرير الإيرادات
- **Folder:** `01-revenue-report/`
...
- **Current intended product surface:** Revenue page
