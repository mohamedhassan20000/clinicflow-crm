# NOTES — Follow-up Analytics Report
...
- **Stable code:** `FOLLOW_UP_ANALYTICS_REPORT`
- **English name:** Follow-up Analytics Report
- **Arabic name:** تقرير الفولو أب
- **Folder:** `11-follow-up-analytics-report/`
...
> **Note:** This is a distinct document from the direct Follow-ups page printout (`FOLLOW_UP_PAGE_REPORT`, folder `02-follow-up-page-report`). Do not merge the two designs.

## Intended print location

- **Current intended product surface:** Reports page
