...
- **Stable code:** `FOLLOW_UP_PAGE_REPORT`
- **English name:** Follow-up Page Report
- **Arabic name:** تقرير المتابعة
- **Folder:** `02-follow-up-page-report/`
...
- **Current intended product surface:** Follow-ups page
