# NOTES — Receptionist Performance Report
...
- **Stable code:** `RECEPTIONIST_PERFORMANCE_REPORT`
- **English name:** Receptionist Performance Report
- **Arabic name:** تقرير أداء موظف الاستقبال
- **Folder:** `13-receptionist-performance-report/`
