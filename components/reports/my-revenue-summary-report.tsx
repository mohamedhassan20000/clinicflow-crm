...
import type { ClinicPrintMeta, MyRevenueSummaryReportResponse, ReportDateRange } from "@/types/reports";
...
export function MyRevenueSummaryReport({
  data,
  range,
  clinic,
}: {
  data: MyRevenueSummaryReportResponse;
