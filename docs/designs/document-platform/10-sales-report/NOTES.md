...
- **Stable code:** `SALES_REPORT`
- **English name:** Sales Report
- **Arabic name:** تقرير المبيعات
- **Folder:** `10-sales-report/`
...
> **Note:** This is a distinct document from the Revenue page report (`REVENUE_REPORT`, folder `01-revenue-report`). Do not merge the two designs.
