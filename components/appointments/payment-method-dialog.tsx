...
const OPTIONS: { value: PaymentMethod; labelKey: string; icon: React.ComponentType<{ className?: string }> }[] = [
  ...
  return (
    ...
    >
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>{t("howDidThePatientPay")}</DialogTitle>
          <DialogDescription>
            {t("selectAPaymentMethodToMark")}</DialogDescription>
        </DialogHeader>
