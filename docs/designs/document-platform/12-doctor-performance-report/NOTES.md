# NOTES — Doctor Performance Report
...
- **Stable code:** `DOCTOR_PERFORMANCE_REPORT`
- **English name:** Doctor Performance Report
- **Arabic name:** تقرير أداء الطبيب
- **Folder:** `12-doctor-performance-report/`
