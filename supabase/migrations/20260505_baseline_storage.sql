...
CREATE POLICY "Admin full access xr6sco_0" ON "storage"."objects" FOR SELECT TO "authenticated" USING ((("bucket_id" = 'clinic-assets'::"text") AND ("auth"."role"() = 'authenticated'::"text")));



CREATE POLICY "Admin full access xr6sco_1" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'clinic-assets'::"text") AND ("auth"."role"() = 'authenticated'::"text")));



CREATE POLICY "Admin full access xr6sco_2" ON "storage"."objects" FOR UPDATE TO "authenticated" USING ((("bucket_id" = 'clinic-assets'::"text") AND ("auth"."role"() = 'authenticated'::"text")));



CREATE POLICY "Admin full access xr6sco_3" ON "storage"."objects" FOR DELETE TO "authenticated" USING ((("bucket_id" = 'clinic-assets'::"text") AND ("auth"."role"() = 'authenticated'::"text")));
...
CREATE POLICY "avatars_owner_insert" ON "storage"."objects" FOR INSERT WITH CHECK ((("bucket_id" = 'avatars'::"text") AND (("auth"."uid"())::"text" = ("storage"."foldername"("name"))[1])));
