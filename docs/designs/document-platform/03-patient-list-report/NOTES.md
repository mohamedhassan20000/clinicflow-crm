...
- **Stable code:** `PATIENT_LIST_REPORT`
- **English name:** Patient List Report
- **Arabic name:** تقرير قائمة المرضى
- **Folder:** `03-patient-list-report/`
...
- **Current intended product surface:** Patients page
