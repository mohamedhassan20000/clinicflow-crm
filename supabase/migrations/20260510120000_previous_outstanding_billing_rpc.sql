-- Phase 11A: atomic appointment billing with optional previous outstanding settlement.
-- Existing billing and settlement RPCs remain unchanged; this is an opt-in path
...
begin
  ...
  -- Lock prior outstanding rows for this patient before calculating/applying
  -- the optional settlement. The current appointment is explicitly excluded.
  perform 1
  from public.appointments
