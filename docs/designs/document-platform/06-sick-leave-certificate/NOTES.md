...
- **Stable code:** `SICK_LEAVE_CERTIFICATE`
- **English name:** Sick Leave Certificate
- **Arabic name:** شهادة الإجازة المرضية
- **Folder:** `06-sick-leave-certificate/`
...
- **Current intended product surface:** Patient visit workspace
