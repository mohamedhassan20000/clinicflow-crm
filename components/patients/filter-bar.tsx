...
import { Building2, Filter, Printer, Stethoscope, X } from "lucide-react";
...
export function PatientsFilterBar({ doctors, departments }: Props) {
  ...
  function set(key: "dept" | "doctor", value: string | null) {
  ...
  const activeCount = Number(!!activeDept) + Number(!!activeDoctor);
