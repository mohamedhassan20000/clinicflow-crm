...
| **Total** | **~105–147** (≈ 6.5–9 months, single developer) | | |
...
- *Dependencies:* P3A (sends via `send.ts`); P3B only for WhatsApp-channel reminders (email reminders work without it).
