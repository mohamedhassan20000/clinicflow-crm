...
- **Stable code:** `INVOICE`
- **English name:** Invoice
- **Arabic name:** الفاتورة
- **Folder:** `16-invoice/`
...
- **Current intended product surface:** Patient profile, appointment billing, invoice history, WhatsApp delivery, and email delivery
